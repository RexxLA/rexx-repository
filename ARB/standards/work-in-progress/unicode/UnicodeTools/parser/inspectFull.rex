 ...
 *
 * <p><code>inspectFull.rex</code> is a sample program for the Rexx Tokenizer. It tokenizes a file,
 *   and prints the full undetailed tokenization. 
 *
...
t = .ooRexx.Unicode.Tokenizer~new(array,0)
