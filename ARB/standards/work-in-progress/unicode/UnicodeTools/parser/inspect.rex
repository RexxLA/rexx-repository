...
-- inspect.rex - is a sample program for the Rexx Tokenizer. It tokenizes a file,
-- and prints the tokenization. By default it uses full, detailed tokenization, but this can be changed.
