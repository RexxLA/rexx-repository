...
* 20240205 &mdash; rxutry.rex autoloads path. Unicode.cls: Options DefaultString and Promote can be set on caller; make Options DefaultString TEXT the default.
