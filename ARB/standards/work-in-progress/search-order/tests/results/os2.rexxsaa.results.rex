...
Pass.15 = .false; Pass.15.test = '.\curr'
...
Pass.21 = .false; Pass.21.test = '..\dotdotcurr'
...
Pass.27 = .false; Pass.27.test = 'lib\..\..\dotdotcurr'
...
Pass.33 = .false; Pass.33.test = '\dotdotcurr'
...
Pass.39 = .false; Pass.39.test = 'Z:curr\curr'
Pass.40 = .true;  Pass.40.test = 'Z:curr\curr.rex'
Pass.41 = .false; Pass.41.test = 'Y:path\path'
Pass.42 = .true;  Pass.42.test = 'Y:path\path.rex'
Pass.43 = .false; Pass.43.test = 'C:\sotest\subdir\dotdotsame\same\same'
Pass.44 = .true;  Pass.44.test = 'C:\sotest\subdir\dotdotsame\same\same.rex'
Pass.45 = .false; Pass.45.test = 'Z:\curr\curr'
Pass.46 = .true;  Pass.46.test = 'Z:\curr\curr.rex'
Pass.47 = .false; Pass.47.test = 'Y:\path\path'
