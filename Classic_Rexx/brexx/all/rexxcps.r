...
numeric digits 14
if datatype(count,"N") = 0 then count=100        /* Repetition count */
if datatype(averaging,"N") = 0 then averaging=100    /* Averaging-over count */
  ...
  do count;
    ...
    do loop=1 to 14
      ...
      do j=1.1 to 2.2 by 1.1   /* executed 28 times */
        ...
        if 17<length(j)-1        then say 'Failed3' j
